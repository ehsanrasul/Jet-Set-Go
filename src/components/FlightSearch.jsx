...
//   // Function to fetch airports based on user query
...
//             className="px-4 py-2 bg-blue-600 text-white rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300" // Fixed width set to 32
//           >
//             Search Flights
//           </button>
//         </div>
